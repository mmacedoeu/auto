from auto.json_parser import decode_history, decode_live, decode_alert, decode_tag
...
from auto.alarm_parser import import_vars as aiv
...
def diff():
    ...
    server_alarm = decode_alert(server_config)
